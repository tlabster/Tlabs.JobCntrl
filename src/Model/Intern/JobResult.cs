...
namespace Tlabs.JobCntrl.Model.Intern {
  ...
  internal class JobResult : IJobResult {
    ...
    public static IReadOnlyDictionary<string, object?> EMPTY_RESULT= ImmutableDictionary<string, object?>.Empty;
    ...
    public JobResult(Task<IJobResult> asyncRes) { this.jobName= "PENDING"; this.asyncRes= asyncRes; }
    ...
    public Task<IJobResult> AsyncResult => asyncRes ?? throw new InvalidOperationException("Invalid async. state.");
